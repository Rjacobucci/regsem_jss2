...
Structural equation modeling is hard, and pairing with regularization doesn't make it any easier. Given this, and the number of options available in the \pkg{regsem} package, a Google group forum was created in order to answer questions and trouble shoot at https://groups.google.com/forum/#!forum/regsem. 
