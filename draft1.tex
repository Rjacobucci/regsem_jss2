...
various forms of penalized likelihood estimation in a broad array of
...
available in the \pkg{regsem} package, a Google group forum was created
...
the \pkg{regsem} package. RegSEM allows the use of regularization while
...
regularization in \pkg{regsem} demonstrated better false positive and
...
(Serang et al. in press). Future updates to \pkg{regsem} will focus on
